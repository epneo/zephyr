...
NET_BUF_POOL_VAR_DEFINE_IN(rx_bufs, CONFIG_NET_BUF_RX_COUNT, CONFIG_NET_PKT_BUF_RX_DATA_POOL_SIZE,
			   CONFIG_NET_PKT_BUF_USER_DATA_SIZE, NULL,
			   __attribute__((section(".ext_ram.bss"))));
NET_BUF_POOL_VAR_DEFINE_IN(tx_bufs, CONFIG_NET_BUF_TX_COUNT, CONFIG_NET_PKT_BUF_TX_DATA_POOL_SIZE,
			   CONFIG_NET_PKT_BUF_USER_DATA_SIZE, NULL,
			   __attribute__((section(".ext_ram.bss"))));
